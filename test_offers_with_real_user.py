...
def get_auth_token():
    ...
    # بيانات تسجيل الدخول للمستخدمين الموجودين
    login_attempts = [
        {'username': '+201020304060', 'password': '123456'},  # User 4 (STORE)
        {'username': '+201090572414', 'password': '123456'},  # User 3 (ADMIN)
        {'username': '+201228898594', 'password': '123456'},  # User 2 (PHARMACY)
        {'username': 'testuser', 'password': 'testpass123'},   # Test user
    ]
    ...
    for login_data in login_attempts:
        try:
            ...
            if response.status_code == 200:
                ...
                return token, role, login_data['username']
            else:
...
def test_upload_offers():
    ...
    # الحصول على token
    token, role, username = get_auth_token()
